...
class AppModes(object):
    ...
    PYTHON_SCRIPT = AppMode(10, 'python-script', 'Python script')

    _modes = [UNKNOWN, SHINY, RMD, SHINY_RMD, STATIC, PLUMBER, TENSORFLOW, JUPYTER_NOTEBOOK, PYTHON_API, DASH_APP, PYTHON_SCRIPT]
