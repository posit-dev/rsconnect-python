...
setup(
    ...
    project_urls={"Documentation": "https://docs.rstudio.com/rsconnect-python",},
    ...
    zip_safe=False,
    install_requires=["six>=1.14.0", "click>=7.0.0",],
    python_requires=">=2.7, !=3.0.*, !=3.1.*, !=3.2.*, !=3.3.*, !=3.4.*",
    entry_points={"console_scripts": ["rsconnect=rsconnect.main:cli"],},
)
