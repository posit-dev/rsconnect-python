...
ADD_CACHE_COMMAND = "docker-compose exec -T rsconnect mkdir -p /data/python-environments/pip/1.2.3"
RM_CACHE_COMMAND = "docker-compose exec -T rsconnect rm -Rf /data/python-environments/pip/1.2.3"
# The following returns int(0) if dir exists, else int(256).
CACHE_EXISTS_COMMAND = "docker-compose exec -T rsconnect [ -d /data/python-environments/pip/1.2.3 ]"
