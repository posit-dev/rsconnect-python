...
def _no_system_keyring() -> Iterator[None]:
    """Generator behind the fixture, importable so tests can drive its teardown."""
    absent = object()
...
def no_system_keyring() -> Iterator[None]:
